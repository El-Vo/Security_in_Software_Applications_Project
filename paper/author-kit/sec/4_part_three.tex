...
For this reason, the \texttt{private} helper function \texttt{addTaxAllowance()} (Listing \ref{lst:add-tax-allowance}) was added. If two Taxpayers divorce, the extended tax allowance must return to the Taxpayer(s) that won the lottery in the first place. To ensure that this is the case, the divorce() function was modified to reset each spouses tax allowance correctly (see Listing \ref{lst:divorce}):
