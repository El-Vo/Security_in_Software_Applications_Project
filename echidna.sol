...
contract TestTaxpayer is Taxpayer {
  ...
  function echidna_marriage_symmetry() public view returns (bool) {
    if (isMarried) {
      ...
      try partner.spouseAddress() returns (address partnersSpouse) {
        return (partnersSpouse == address(this) && partner.isMarriedState());
      } catch {
  ...
  function echidna_valid_married_tax_allowance() public view returns (bool) {
    if (isMarriedState()) {
      ...
      return (combined == 10000 || combined == 12000 || combined == 14000);
    }
    return true;
  }
  ...
  /** 
    ...
    */
  function echidna_valid_married_tax_allowance_over_64() public view returns (bool) {
